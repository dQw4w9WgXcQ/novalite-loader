...
public class DefinitionCache implements Definitions {
    ...
    public ItemComposition getItemDefinition(int id) {
        return ClientThreadUtil.invoke(clientThread, () -> client.getItemDefinition(id));
    }

    @Override
    public NPCComposition getNpcDefinition(int id) {
        return ClientThreadUtil.invoke(clientThread, () -> client.getNpcDefinition(id));
    }

    @Override
    public ObjectComposition getObjectDefinition(int id) {
        return ClientThreadUtil.invoke(clientThread, () -> client.getObjectDefinition(id));
    }
}
//@Slf4j
//public class DefinitionCache implements Definitions {
